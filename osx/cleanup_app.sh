...
rm -rf "$PYPATH/3.5.0/lib/python3.5/tkinter"
rm -rf "$PYPATH/"3.5.0/bin/{pygmentize,2to*,pip*,*-config,easy_install*,idle*,pydoc*,python3.5m*,rst*,pip*}
rm -rf "$PYPATH/"3.5.0/lib/{lib*,pkgconfig}
rm -rf "$PYPATH/"3.5.0/include
