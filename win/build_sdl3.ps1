...
$WINDOWS__SDL3_MIXER__URL="https://github.com/libsdl-org/SDL_mixer/releases/release-$WINDOWS__SDL3_MIXER__VERSION/SDL3_mixer-$WINDOWS__SDL3_MIXER__VERSION.tar.gz"
