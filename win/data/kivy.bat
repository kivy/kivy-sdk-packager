...
set PATH=%kivy_portable_root%;%kivy_portable_root%Python;%kivy_portable_root%tools;%kivy_portable_root%Python\Scripts;%kivy_portable_root%gstreamer\bin;%kivy_portable_root%MinGW\bin;%kivy_portable_root%MinGW\msys\1.0\bin;%kivy_portable_root%SDL2\bin;%PATH%
ECHO PATH:
ECHO %PATH%
ECHO ----------------------------------
