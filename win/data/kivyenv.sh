...
export PATH=$KIVY_PORTABLE_ROOT:$KIVY_PORTABLE_ROOT/Python:$KIVY_PORTABLE_ROOT/Python/Scripts:$KIVY_PORTABLE_ROOT/MinGW/bin:$kivy_portable_root/SDL2/bin:$KIVY_PORTABLE_ROOT/gstreamer/bin:$PATH
echo PATH is $PATH
echo ----------------------------------
